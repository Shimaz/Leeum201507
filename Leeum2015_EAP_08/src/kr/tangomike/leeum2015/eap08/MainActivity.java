...
package kr.tangomike.leeum2015.eap08;
...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        /* get Values */
        oscIP = settings.getString("myIP", "192.168.0.144");
        ...
        FrameLayout.LayoutParams frameLP = new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
...
//    	// pass touch events to touchView
//    	this.touchView.retriveTouchEvent(event);
//    	
//    	return true;
//    }
    
//    private void addContentView(ImageView logoLeft, LayoutParams layoutParams) {
...
//	}
    ...
    private void openSettingsActivity (){
    	...
    	myIntent.setClassName("kr.tangomike.leeum2015.eap08", "kr.tangomike.leeum2015.eap08.SettingsActivity"); 
    ...
    private void openHelpActivity (){
    	Intent myIntent = new Intent();
     	myIntent.setClassName("kr.tangomike.leeum2015.eap08", "kr.tangomike.leeum2015.eap08.HelpActivity");
     	showSettings = true;
