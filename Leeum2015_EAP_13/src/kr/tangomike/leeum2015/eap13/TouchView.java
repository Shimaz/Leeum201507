...
package kr.tangomike.leeum2015.eap13;
...
public class TouchView extends SurfaceView implements SurfaceHolder.Callback {
	...
	private static final int defaultNavY = 575;
	private static final float minNavScale = 87.5f;
	...
	private int bgX = 221;
	private int bgY = 281;
	private int bgRight = 590;
	private int bgBottom = 858;
	...
	public TouchView(Context context, String oscIP, int oscPort, boolean drawAdditionalInfo, boolean sendPeriodicUpdates) {
		...
		for (int i = 0; i < 72; i++){
			...
			int ir = getResources().getIdentifier("smy_" + str, "raw", PACKAGE_NAME);
			Bitmap tmpBmp;
