package kr.tangomike.leeum2015.eap.edu_a;
...
//	private RelativeLayout rlContent;
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        ivTitle.setImageResource(R.drawable.a_1_title_kor);
...
//					mHandler.sendEmptyMessageDelayed(0, 1000);
	...
	private void setPageContent(int pageNumber, boolean lang){
		...
		if(lang){
			int rID = getResources().getIdentifier("a_" + tmp + "_title_kor", "drawable", getPackageName()); 
	        ...
	        while(true){
	        	...
	        	String ttt = "a_" + tmp + "_text_kor_" + i;
	        	android.util.Log.i("scrl", ttt);
	        	
	        	if(getResources().getIdentifier("a_" + tmp + "_text_kor_" + i, "drawable", getPackageName()) != 0){
	        		ImageView iv = new ImageView(getApplicationContext());
	        		iv.setImageResource(getResources().getIdentifier("a_" + tmp + "_text_kor_" + i, "drawable", getPackageName()));
	        		llContent.addView(iv);
	        		
	        		android.util.Log.i("content", "a_" + tmp + "_text_kor_" + i);
			...
			int rID = getResources().getIdentifier("a_" + tmp + "_title_eng", "drawable", getPackageName()); 
	        ivTitle.setImageResource(rID);
	        
	        
	        int i = 1;
	        while(true){
	        	if(getResources().getIdentifier("a_" + tmp + "_text_eng_" + i, "drawable", getPackageName()) != 0){
	        		ImageView iv = new ImageView(getApplicationContext());
	        		iv.setImageResource(getResources().getIdentifier("a_" + tmp + "_text_eng_" + i, "drawable", getPackageName()));
	        		llContent.addView(iv);
	        		
	        		android.util.Log.i("content", "a_" + tmp + "_text_eng_" + i);
	...
	public class SugimotoPagerAdapter extends PagerAdapter{
		...
		public Object instantiateItem(View collection, int position) {
	        ...
	        int rID = getResources().getIdentifier("a_" + tmp + "_img", "drawable", getPackageName()); 
